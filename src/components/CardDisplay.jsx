export default function CardDisplay({ card, onManageLimits, transactions = [] }) {
    ...
    <div className="flex flex-col items-start mb-6">
      ...
      {onManageLimits && (
        <button
          ...
          className="mt-4 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 transition-colors cursor-pointer text-sm"
        >
